...
```{r fit_many_parallel_devmode, message=FALSE, warning=FALSE, include=FALSE}
# start timer
...
```{r fit_many_parallel, echo=TRUE, eval = FALSE, message=FALSE, warning=FALSE}
# start timer
parallel_start <- Sys.time()
...
```{r parallel_plot, fig.height = 12, fig.width=8, fig.cap="Fitted TPCs"}
# plot
ggplot(d_preds) +
