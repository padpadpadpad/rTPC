...
# fit model
mod <- nls.multstart::nls_multstart(rate~atkin_2005(temp = temp, a, b, c),
                                    data = d,
                                    iter = c(3,3,3),
...
# run test
testthat::test_that("atkin_2005 function works", {
  testthat::expect_equal(
    round(preds$.fitted, 1),
    c(0.1, 0.1, 0.3, 0.4, 0.7, 1.1, 1.4, 1.6, 1.5, 1, 0.5, 0.1))
})
