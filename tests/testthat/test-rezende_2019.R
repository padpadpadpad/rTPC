...
# fit model
mod <- suppressWarnings(nls.multstart::nls_multstart(rate~rezende_2019(temp = temp, q10,a,b,c),
                                                     data = d,
...
# run test
testthat::test_that("rezende_2019 function works", {
  testthat::expect_equal(
    round(preds$.fitted, 1),
    c(0.3,  0.4,  0.5,  0.6,  0.8,  1.0,  1.2,  1.3,  1.3,  1.2,  0.8, -0.1))
})
