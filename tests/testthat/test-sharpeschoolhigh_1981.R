context("test-sharpeschoolhigh_1981.R")
...
# fit model
mod <- suppressWarnings(nls.multstart::nls_multstart(rate~sharpeschoolhigh_1981(temp = temp, r_tref,e,eh,th, tref = 15),
                                                     data = d,
...
# run test
testthat::test_that("sharpeschoolhigh_1981 function works", {
  testthat::expect_equal(
    round(preds$.fitted, 1),
    c(0.3, 0.4, 0.5, 0.6, 0.7, 0.9, 1.1, 1.4, 1.7, 1.5, 0.0, 0.0))
})
