...
# fit model
mod <- suppressWarnings(nls.multstart::nls_multstart(rate~thomas_2017(temp = temp, a,b,c,d,e),
                                                     data = d,
...
# run test
testthat::test_that("thomas_2017 function works", {
