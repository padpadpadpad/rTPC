...
# fit model
mod <- suppressWarnings(nls.multstart::nls_multstart(rate~weibull_1995(temp = temp, a, topt, b, c),
                                                     data = d,
...
# run test
testthat::test_that("weibull_1995 function works", {
  testthat::expect_equal(
    round(preds$.fitted, 1),
    c(0.1, 0.2, 0.3, 0.5, 0.7, 1.0, 1.3, 1.6, 1.5, 1.1, 0.5, 0.1))
})
