---
title: "Modelling a thermal performance curve using rTPC and nls.multstart"
author: "Daniel Padfield"
output: rmarkdown::html_vignette
date: "`r Sys.Date()`"
description: >
  A brief introduction as to how rTPC can be used to fit a thermal performance curve using nls.multstart.
vignette: >
...
When developing **rTPC**, we made a conscious decision to not re-write workflows and code that is already available in the R ecosystem. Consequently, to overcome the above problem, we recommend using the R package [**nls.multstart**](https://github.com/padpadpadpad/nls.multstart), which uses **minpackLM::nlsLM()** but allows for multiple sets of starting parameters. It iterates through multiple starting values, attempting a fit with each set of start parameters. The best model is then picked on AIC score.
