...
- Bootstrapping can also allow differences between estimated and calculated parameters to be evaluated.
...
- Case resampling will be sensitive to the number of unique data points and the model being used.
...
Bootstrapping can be used to estimate confidence intervals of estimated and calculated parameters.
