...
- To follow the general pipeline, see vignette("fit_many_curves") and vignette("fit_many_models").
- For examples of extensions to this pipeline, see the vignette("model_averaging_selection") and vignette("model_weighting").
