...
From these fits, we can also take advantage of model selection methods such as the __AICc__ score. We can calculate model weights of these to see which model is most supported. 
...
```{r scale_up_stack, warning=FALSE}
# stack models
d_stack <- gather(d_models, 'model', 'output', 6:ncol(d_models))
