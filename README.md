...
We can then easily implement this code on many different models and plot
the output. For example we can fit this model ensemble to each of 15
curves from the dataset, calculate the **AICc** for each one and then
plot the model averaged curve.
