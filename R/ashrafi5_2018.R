...
#' theme_bw()
#' @export ashrafi5_2018

ashrafi5_2018 <- function(temp, a, b, c, d){
...
ashrafi5_2018.starting_vals <- function(d){
...
ashrafi5_2018.lower_lims <- function(d){
  a = -Inf
  b = -Inf
  c = -Inf
  d = -Inf
...
ashrafi5_2018.upper_lims <- function(d){
  a = Inf
  b = Inf
  c = Inf
  d = Inf
