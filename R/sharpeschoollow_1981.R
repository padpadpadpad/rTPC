...
sharpeschoollow_1981 <- function(temp, r_tref, e, el, tl, tref){
  tref <- 273.15 + tref
  k <- 8.62e-05
...
sharpeschoollow_1981.starting_vals <- function(d){
...
sharpeschoollow_1981.lower_lims <- function(d){
  r_tref = 0
  e = 0
...
sharpeschoollow_1981.upper_lims <- function(d){
